...
export class AdminButtonComponent {
  ...
  readonly buttonClass = computed(() => {
    const base = 'inline-flex items-center justify-center font-medium transition-colors duration-150 rounded focus:outline-none focus:ring-2 focus:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer';
    
    const variants = {
      primary: 'bg-slate-800 hover:bg-slate-900 text-white focus:ring-slate-800 border border-transparent shadow-sm',
      ...
      outline: 'bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 focus:ring-slate-300 shadow-sm',

...
export class HomeComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    @ViewChild('kopiShowcaseCarouselViewport')
    kopiShowcaseCarouselViewport?: ElementRef<HTMLElement>;
    ...
    readonly mardikaKopiCards = signal<KopiShowcaseCard[]>([
        {
            ...
            description:
                'Karakter rasa dark chocolate, karamel manis, dan bodi tebal. Teman terbaik membaca mendalam dan kopi susu aren.',
            link: '/',
        },
        {
            ...
            description:
                'Aroma floral jeruk dengan keasaman segar dan body medium seimbang. Pas untuk seduhan pour over V60 manual.',
            link: '/',
        },
        {
            ...
            description:
                'Body tebal mantap dengan notes dark cocoa dan rempah gurih tanpa rasa pahit gosong berlebih.',
            link: '/',
        },
        {
            ...
            description:
                'Ekstraksi dingin 16 jam menghasilkan kopi pekat yang lembut di lambung dan menyegarkan.',
            link: '/',
        },
        {
            ...
            description:
                'Nikmati kopi filter artisan di mana saja tanpa alat seduh khusus. Cukup tuang air panas.',
            link: '/',
        },
        {
            ...
            description:
                'Perpaduan espresso mantap, susu creamy, dan gula aren organik asli yang legit dan pas.',
            link: '/',
        },
    ]);
    ...
    readonly signatureProduct = computed<Product>(() => {
        ...
        return {
            ...
            description:
                'Biji kopi sangrai artisan perpaduan Arabica & Fine Robusta pilihan. Tasting notes cokelat karamel, bodi mantap dan aftertaste manis seimbang.',
            coverImage:
    ...
    readonly gayoProduct = computed<Product>(() => {
        ...
        const found = items.find(
            (p) =>
                p.title.toLowerCase().includes('gayo') || p.title.toLowerCase().includes('arabica'),
        );
        if (found) return found;
        ...
        return {
            ...
            description:
                '100% Arabica Specialty Single Origin dataran tinggi Aceh Gayo. Proses basah (full wash) menghasilkan aroma floral jeruk dengan keasaman bersih dan manis madu.',
            coverImage:
    ...
    readonly bundleProduct = computed<Product>(() => {
        ...
        return {
            ...
            description:
                'Paket lengkap penjelajah rasa: Mardika Signature Blend 250g, Arabica Gayo 200g, plus Drip Bag Coffee Box (5 sachet) dan stiker eksklusif Mardika.',
            coverImage:
    ...
    readonly dripProduct = computed<Product>(() => {
        ...
        const found = items.find(
            (p) =>
                p.title.toLowerCase().includes('drip') || p.title.toLowerCase().includes('sachet'),
        );
        if (found) return found;
        ...
        return {
            ...
            compareAtPrice: 55000,
            description:
                'Nikmati seduhan kopi filter artisan di mana saja tanpa alat seduh khusus. Berisi 5 sachet kopi single origin dengan filter gantung food-grade.',
            coverImage:
                'https://images.unsplash.com/photo-1511920170033-f8396924c348?auto=format&fit=crop&w=800&q=80',
            publisher: 'Mardika Roastery',
            publishedYear: 2025,
    ...
    readonly beverageProduct = computed<Product>(() => {
        ...
        return {
            ...
            description:
                'Ekstraksi dingin perlahan selama 16 jam menghasilkan konsentrat kopi dengan rasa manis alami seimbang, bebas rasa asam menusuk, dan siap saji.',
            coverImage:
    ...
    ngOnInit() {
        this.seoService.updatePage({
            ...
            description:
                'Koleksi biji kopi specialty sangrai segar dari Aceh Gayo, Temanggung, dan Flores untuk menjaga ketajaman fokus membaca dan kejernihan berpikir.',
        });
    ...
    async loadKopiItems() {
        ...
        try {
            ...
            const items = allItems.filter(
                (i) => (isAdminSession() || i.isActive !== false) && i.itemType === 'mardika',
            );
            ...
            for (const item of items) {
                products.push({
                    ...
                    additionalImages: ((item as { additionalImages?: string[] }).additionalImages ||
                        []) as unknown as any[],
                });
            }
    ...
    ngAfterViewInit() {
        ...
        if (this.testimonialCarouselViewport?.nativeElement) {
        ...
        if (this.kopiShowcaseCarouselViewport?.nativeElement) {
            this.showcaseEmbla = EmblaCarousel(this.kopiShowcaseCarouselViewport.nativeElement, {
                loop: true,
                align: 'start',
                duration: 35,
            });
